...
export default class PlayerCollisionManager extends Phaser.GameObjects.GameObject {
    ...
    private handleCollision(player : Phaser.Types.Physics.Arcade.GameObjectWithBody | Phaser.Tilemaps.Tile, block : Phaser.Types.Physics.Arcade.GameObjectWithBody | Phaser.Tilemaps.Tile) : boolean {
        //Process damage
        if(player instanceof Player && player.body instanceof Phaser.Physics.Arcade.Body && block instanceof Block && block.body instanceof Phaser.Physics.Arcade.Body) {
    ...
    private processCollision(player : Phaser.Types.Physics.Arcade.GameObjectWithBody | Phaser.Tilemaps.Tile, block : Phaser.Types.Physics.Arcade.GameObjectWithBody | Phaser.Tilemaps.Tile) : boolean {
